...
export function useLastTeamId(teams: Team[]): [string | null, (id: string | null) => void] {
  const [activeTeamId, setActiveTeamId] = useState<string | null>(() => {
    ...
    // Verify the saved team still exists and user is a member
    return teams.some((t) => t.id === saved) ? saved : null;
  });

  // Sync on teams change (in case a team was deleted / user was removed)
  useEffect(() => {
